          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-[100px] items-center justify-between">
              ...
              <div className="text-white max-w-3xl">
                ...
                <div className="mt-6">
                  <Link
                    to={`https://myfayda.up.railway.app/developerportal?apiKey=${import.meta.env.VITE_APP_DEFAULT_API_KEY}&login_url=${encodeURIComponent(import.meta.env.VITE_APP_LOGIN_URL)}`}
